...
function mudarValores2() {
    div_tudo_valores.innerHTML = `
    <section class="template-valores">
    <img src="imagens/home/iconeQualidade.png" class="icone-valores" width="90px">
    <h1 class="valores-titulo">Qualidade</h1>
    <p class="valores-paragrafo">Somos movidos pela busca incansável pela excelência. Nossos produtos são projetados e
      fabricados com os mais altos padrões de qualidade para atender e superar as expectativas de nossos
      clientes.</p>
</section>
<section class="template-valores">
    <img src="imagens/home/iconeEtica.png" class="icone-valores">
    <h1 class="valores-titulo">Ética</h1>
    <p class="valores-paragrafo">Operamos com transparência, honestidade e integridade em todos os aspectos de nossos
      negócios. Mantemos nossos compromissos e promessas.</p>
</section>
<section class="template-valores">
    <img src="imagens/home/iconeInovacao.png" class="icone-valores">
    <h1 class="valores-titulo">Inovação</h1>
    <p class="valores-paragrafo">Estamos sempre buscando maneiras de melhorar nossos produtos e serviços, incluindo a
